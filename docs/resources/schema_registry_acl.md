...
terraform import redpanda_schema_registry_acl.prefix "cluster-123:User:bob:SUBJECT:orders-:PREFIXED:*:WRITE:ALLOW"
```

**Note:** Principals containing colons (e.g., `RedpandaRole:admin:extra`) are supported in the import format.
