...
- **`review/`** — user-invoked `/review [N]`; spawns the `reviewer` agent in `.claude/agents/`, which reads the diff against `.claude/review-policy.md` and prints findings. Read-only; posts nothing.
