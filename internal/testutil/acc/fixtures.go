...
var (
	...
	AzureByoVpcClusterDir          = filepath.Join(RepoRoot(), "redpanda", "tests", "testdata", "byovpc", "azure")
	AzureByoVpcNetworkDir          = filepath.Join(RepoRoot(), "redpanda", "tests", "testdata", "byovpc", "azure_network")
	AzureByoVpcClusterOnNetworkDir = filepath.Join(RepoRoot(), "redpanda", "tests", "testdata", "byovpc", "azure_cluster")
