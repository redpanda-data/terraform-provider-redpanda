...
// ShadowLink sweeps a shadow link by name (optionally filtered by shadow cluster id).
...
// SweepShadowLinks deletes the shadow link matching LinkName.
func (s ShadowLink) SweepShadowLinks(_ string) error {
