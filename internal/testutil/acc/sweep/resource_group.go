...
// ResourceGroup sweeps a Redpanda Cloud resource group by name.
type ResourceGroup struct {
	ResourceGroupName string
	Client            *cloud.ControlPlaneClientSet
}

// SweepResourceGroup deletes the resource group matching ResourceGroupName.
func (s ResourceGroup) SweepResourceGroup(_ string) error {
