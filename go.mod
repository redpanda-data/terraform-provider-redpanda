...
require (
	buf.build/gen/go/redpandadata/cloud/grpc/go v1.5.1-20241024195046-353ea4645e3d.1
	buf.build/gen/go/redpandadata/cloud/protocolbuffers/go v1.34.2-20241024195046-353ea4645e3d.2
