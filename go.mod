...
require (
	...
	buf.build/gen/go/redpandadata/dataplane/grpc/go v1.4.0-20240612115640-019a5976954f.1
	buf.build/gen/go/redpandadata/dataplane/protocolbuffers/go v1.34.1-20240612115640-019a5976954f.1
