...
require (
	...
	buf.build/gen/go/redpandadata/cloud/protocolbuffers/go v1.35.2-20241024195046-353ea4645e3d.1
...
require (
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.35.2-20240508200655-46a4cf4ba109.1 // indirect
	buf.build/gen/go/grpc-ecosystem/grpc-gateway/protocolbuffers/go v1.35.2-20221127060915-a1ecdc58eccd.1 // indirect
	buf.build/gen/go/redpandadata/cloud/connectrpc/go v1.16.1-20240429184619-354e1dfbafca.1 // indirect
	buf.build/gen/go/redpandadata/common/protocolbuffers/go v1.35.2-20240508150812-e0d0fbd58f25.1 // indirect
