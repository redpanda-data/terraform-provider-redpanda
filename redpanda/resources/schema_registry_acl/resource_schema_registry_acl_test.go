...
func Test_parseImportID(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			importID: "cluster-2:User:admin:REGISTRY:*:LITERAL:*:ALL:ALLOW",
			want: &importIDComponents{
				clusterID:    "cluster-2",
				principal:    "User:admin",
				resourceType: "REGISTRY",
		...
		},
		{
			...
			importID: "cluster-1:User:bob:SUBJECT:prod-:PREFIXED:192.168.1.1:WRITE:ALLOW",
			want: &importIDComponents{
				clusterID:    "cluster-1",
				principal:    "User:bob",
				resourceType: "SUBJECT",
		...
		},
		{
			...
			importID: "cluster-1:User:eve:SUBJECT:restricted:LITERAL:*:DELETE:DENY",
			want: &importIDComponents{
				clusterID:    "cluster-1",
				principal:    "User:eve",
				resourceType: "SUBJECT",
		...
		{
			name:      "invalid - missing parts (only 7 parts)",
			importID:  "cluster-1:User:SUBJECT:test:LITERAL:*:READ",
			want:      nil,
			wantErr:   true,
			errString: "got 7 parts (expected at least 8)",
		},
		{
			name:      "invalid - missing parts (only 6 parts)",
			importID:  "cluster-1:User:alice:SUBJECT:test:LITERAL:*",
			want:      nil,
			wantErr:   true,
			errString: "got 7 parts (expected at least 8)",
		},
		{
			...
			want:      nil,
			wantErr:   true,
			errString: "got 1 parts (expected at least 8)",
		},
		{
			name:     "valid - only colons (8 parts)",
			importID: "::::::::",
			want: &importIDComponents{
				clusterID:    "",
				principal:    ":",
		...
		{
			name:     "valid - exact 8 parts",
			importID: "c:p:t:n:pt:h:o:perm",
			want: &importIDComponents{
				clusterID:    "c",
				principal:    "p",
				resourceType: "t",
