	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"serverless_region": schema.StringAttribute{
				Computed:    true,
				Description: "Cloud provider specific region of the serverless cluster",
			},
			"allow_deletion": schema.BoolAttribute{
				Computed:    true,
				Description: "allows deletion of the serverless cluster. defaults to true. Not recommended for production use",
			},
