...
// against schema drift. Nothing in CI runs terraform validate over examples/,
// so renaming or removing an rpsql attribute would silently leave users
// copying config the provider rejects.
