...
func TestGenerateModel(t *testing.T) {
	testCases := []struct {
		...
		{
			name: "Basic BYOC cluster with AWS Private Link",
			cfg: models.Cluster{
				Name:            types.StringValue("testname"),
				ConnectionType:  types.StringValue("public"),
				CloudProvider:   types.StringValue("aws"),
				...
				ResourceGroupID: types.StringValue("rg-test"),
				NetworkID:       types.StringValue("net-test"),
				Zones:           utils.StringSliceToTypeList([]string{"use2-az1", "use2-az2", "use2-az3"}),
				AllowDeletion:   types.BoolValue(true),
				AwsPrivateLink: &models.AwsPrivateLink{
					Enabled:           types.BoolValue(true),
					ConnectConsole:    types.BoolValue(true),
					AllowedPrincipals: utils.StringSliceToTypeList([]string{"arn:aws:iam::123456789024:root"}),
				},
			},
			cluster: &controlplanev1beta2.Cluster{
				Id:              "cl-test",
				...
				DataplaneApi: &controlplanev1beta2.Cluster_DataplaneAPI{
					Url: "https://test-cluster.rptest.io:443",
				},
				AwsPrivateLink: &controlplanev1beta2.AWSPrivateLinkStatus{
					Enabled:           true,
					ConnectConsole:    true,
					AllowedPrincipals: []string{"arn:aws:iam::123456789024:root"},
				},
			},
			expected: &models.Cluster{
				Name:            types.StringValue("testname"),
		...
		{
			name: "Cluster with empty zones and no private link config",
			cfg: models.Cluster{
				Name:            types.StringValue("testname"),
				ConnectionType:  types.StringValue("public"),
				CloudProvider:   types.StringValue("aws"),
			...
			expected: &models.Cluster{
				...
				ClusterAPIURL:         types.StringValue("https://test-cluster.rptest.io:443"),
				AllowDeletion:         types.BoolValue(true),
				Zones:                 basetypes.NewListNull(types.StringType),
				ReadReplicaClusterIDs: basetypes.NewListNull(types.StringType),
			},
			wantErr: false,
		},
