...
func generateGCPCMR(ctx context.Context, cmrObj types.Object) (*controlplanev1.Network_CustomerManagedResources_GCP, error) {
...
func generateAWSCMR(ctx context.Context, cmrObj types.Object) (*controlplanev1.Network_CustomerManagedResources_AWS, error) {
	...
	privateSubnetsArns, err := utils.GetListFromAttributes("private_subnets", aws.Attributes())
	if err != nil {
...
func generateModelGCPCMR(ctx context.Context, gcpData *controlplanev1.Network_CustomerManagedResources_GCP) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	gcpVal := getGcpNull().Attributes()
