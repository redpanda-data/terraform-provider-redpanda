...
func TestResourceModel_ConvertSchemaType(t *testing.T) {
	tests := []struct {
		...
		{"AVRO proto form", "SCHEMA_TYPE_AVRO", sr.TypeAvro},
		{"avro proto form lowercase", "schema_type_avro", sr.TypeAvro},
		{"JSON uppercase", "JSON", sr.TypeJSON},
		{"json lowercase", "json", sr.TypeJSON},
		{"Json mixed case", "Json", sr.TypeJSON},
		{"JSON proto form", "SCHEMA_TYPE_JSON", sr.TypeJSON},
		...
		{"PROTOBUF proto form", "SCHEMA_TYPE_PROTOBUF", sr.TypeProtobuf},
