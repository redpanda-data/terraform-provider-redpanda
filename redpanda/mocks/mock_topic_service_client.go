...
// Source: buf.build/gen/go/redpandadata/dataplane/grpc/go/redpanda/api/dataplane/v1alpha2/dataplanev1alpha2grpc (interfaces: TopicServiceClient)
...
func (m *MockTopicServiceClient) CreateTopic(arg0 context.Context, arg1 *dataplanev1alpha2.CreateTopicRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.CreateTopicResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.CreateTopicResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTopicServiceClient) DeleteTopic(arg0 context.Context, arg1 *dataplanev1alpha2.DeleteTopicRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.DeleteTopicResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.DeleteTopicResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTopicServiceClient) GetTopicConfigurations(arg0 context.Context, arg1 *dataplanev1alpha2.GetTopicConfigurationsRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.GetTopicConfigurationsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.GetTopicConfigurationsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTopicServiceClient) ListTopics(arg0 context.Context, arg1 *dataplanev1alpha2.ListTopicsRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.ListTopicsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.ListTopicsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTopicServiceClient) SetTopicConfigurations(arg0 context.Context, arg1 *dataplanev1alpha2.SetTopicConfigurationsRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.SetTopicConfigurationsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.SetTopicConfigurationsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTopicServiceClient) UpdateTopicConfigurations(arg0 context.Context, arg1 *dataplanev1alpha2.UpdateTopicConfigurationsRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.UpdateTopicConfigurationsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.UpdateTopicConfigurationsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
