...
// Source: buf.build/gen/go/redpandadata/dataplane/grpc/go/redpanda/api/dataplane/v1alpha2/dataplanev1alpha2grpc (interfaces: UserServiceClient)
...
func (m *MockUserServiceClient) CreateUser(arg0 context.Context, arg1 *dataplanev1alpha2.CreateUserRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.CreateUserResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.CreateUserResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserServiceClient) DeleteUser(arg0 context.Context, arg1 *dataplanev1alpha2.DeleteUserRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.DeleteUserResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.DeleteUserResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserServiceClient) ListUsers(arg0 context.Context, arg1 *dataplanev1alpha2.ListUsersRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.ListUsersResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.ListUsersResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserServiceClient) UpdateUser(arg0 context.Context, arg1 *dataplanev1alpha2.UpdateUserRequest, arg2 ...grpc.CallOption) (*dataplanev1alpha2.UpdateUserResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*dataplanev1alpha2.UpdateUserResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
