...
func (m *MockOperationServiceClient) GetOperation(arg0 context.Context, arg1 *controlplanev1.GetOperationRequest, arg2 ...grpc.CallOption) (*controlplanev1.GetOperationResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockOperationServiceClient) ListOperations(arg0 context.Context, arg1 *controlplanev1.ListOperationsRequest, arg2 ...grpc.CallOption) (*controlplanev1.ListOperationsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
